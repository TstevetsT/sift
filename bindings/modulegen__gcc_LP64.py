...
def module_init():
    root_module = Module('ns.sift', cpp_namespace='::ns3')
    return root_module
...
def register_types(module):
    ...
    ## sift-helper.h (module 'sift'): ns3::SiftHelper [class]
    module.add_class('SiftHelper')
    ## sift-main-helper.h (module 'sift'): ns3::SiftMainHelper [class]
    module.add_class('SiftMainHelper')
    ...
    ## Register a nested module for the namespace sift
    
    nested_module = module.add_cpp_namespace('sift')
    register_types_ns3_sift(nested_module)
...
def register_types_ns3_sift(module):
    root_module = module.get_root()
    
    ## sift-repository.h (module 'sift'): ns3::sift::GeographicTuple [struct]
    module.add_class('GeographicTuple')
    ## sift-geo.h (module 'sift'): ns3::sift::SiftGeo [class]
    module.add_class('SiftGeo')
    ## sift-header.h (module 'sift'): ns3::sift::SiftHeader [class]
    module.add_class('SiftHeader', parent=root_module['ns3::Header'])
    ## sift-routing.h (module 'sift'): ns3::sift::SiftRouting [class]
    module.add_class('SiftRouting', parent=root_module['ns3::IpL4Protocol'])
    ## sift-geo.h (module 'sift'): ns3::sift::TimeFragments [struct]
    module.add_class('TimeFragments')
    module.add_container('std::vector< ns3::sift::GeographicTuple >', 'ns3::sift::GeographicTuple', container_type=u'vector')
    module.add_container('std::vector< ns3::Ipv4Address >', 'ns3::Ipv4Address', container_type=u'vector')
    module.add_container('std::map< ns3::Ptr< ns3::Packet >, ns3::Time >', ('ns3::Ptr< ns3::Packet >', 'ns3::Time'), container_type=u'map')
    typehandlers.add_type_alias(u'std::vector< ns3::sift::GeographicTuple, std::allocator< ns3::sift::GeographicTuple > >', u'ns3::sift::GeographicSet')
    typehandlers.add_type_alias(u'std::vector< ns3::sift::GeographicTuple, std::allocator< ns3::sift::GeographicTuple > >*', u'ns3::sift::GeographicSet*')
    typehandlers.add_type_alias(u'std::vector< ns3::sift::GeographicTuple, std::allocator< ns3::sift::GeographicTuple > >&', u'ns3::sift::GeographicSet&')
...
def register_methods(root_module):
    ...
    register_Ns3SiftHelper_methods(root_module, root_module['ns3::SiftHelper'])
    register_Ns3SiftMainHelper_methods(root_module, root_module['ns3::SiftMainHelper'])
    ...
    register_Ns3SiftGeographicTuple_methods(root_module, root_module['ns3::sift::GeographicTuple'])
    register_Ns3SiftSiftGeo_methods(root_module, root_module['ns3::sift::SiftGeo'])
    register_Ns3SiftSiftHeader_methods(root_module, root_module['ns3::sift::SiftHeader'])
    register_Ns3SiftSiftRouting_methods(root_module, root_module['ns3::sift::SiftRouting'])
    register_Ns3SiftTimeFragments_methods(root_module, root_module['ns3::sift::TimeFragments'])
    return
...
def register_Ns3SiftHelper_methods(root_module, cls):
    ## sift-helper.h (module 'sift'): ns3::SiftHelper::SiftHelper() [constructor]
    cls.add_constructor([])
    ## sift-helper.h (module 'sift'): ns3::SiftHelper::SiftHelper(ns3::SiftHelper const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::SiftHelper const &', 'arg0')])
    ## sift-helper.h (module 'sift'): ns3::SiftHelper * ns3::SiftHelper::Copy() const [member function]
    cls.add_method('Copy', 
                   'ns3::SiftHelper *', 
                   [], 
                   is_const=True)
    ## sift-helper.h (module 'sift'): ns3::Ptr<ns3::sift::SiftRouting> ns3::SiftHelper::Create(ns3::Ptr<ns3::Node> node) const [member function]
    cls.add_method('Create', 
                   'ns3::Ptr< ns3::sift::SiftRouting >', 
                   [param('ns3::Ptr< ns3::Node >', 'node')], 
                   is_const=True)
    ## sift-helper.h (module 'sift'): void ns3::SiftHelper::Set(std::string name, ns3::AttributeValue const & value) [member function]
    cls.add_method('Set', 
                   'void', 
                   [param('std::string', 'name'), param('ns3::AttributeValue const &', 'value')])
    ## sift-helper.h (module 'sift'): void ns3::SiftHelper::SetNodes(ns3::NodeContainer & nodes) [member function]
    cls.add_method('SetNodes', 
                   'void', 
                   [param('ns3::NodeContainer &', 'nodes')])
    return

def register_Ns3SiftMainHelper_methods(root_module, cls):
    ## sift-main-helper.h (module 'sift'): ns3::SiftMainHelper::SiftMainHelper() [constructor]
    cls.add_constructor([])
    ## sift-main-helper.h (module 'sift'): ns3::SiftMainHelper::SiftMainHelper(ns3::SiftMainHelper const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::SiftMainHelper const &', 'arg0')])
    ## sift-main-helper.h (module 'sift'): void ns3::SiftMainHelper::Install(ns3::SiftHelper & siftHelper, ns3::NodeContainer nodes) [member function]
    cls.add_method('Install', 
                   'void', 
                   [param('ns3::SiftHelper &', 'siftHelper'), param('ns3::NodeContainer', 'nodes')])
    ## sift-main-helper.h (module 'sift'): void ns3::SiftMainHelper::SetSiftHelper(ns3::SiftHelper & siftHelper) [member function]
    cls.add_method('SetSiftHelper', 
                   'void', 
                   [param('ns3::SiftHelper &', 'siftHelper')])
    return
...
def register_Ns3SiftGeographicTuple_methods(root_module, cls):
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## sift-repository.h (module 'sift'): ns3::sift::GeographicTuple::GeographicTuple() [constructor]
    cls.add_constructor([])
    ## sift-repository.h (module 'sift'): ns3::sift::GeographicTuple::GeographicTuple(ns3::sift::GeographicTuple const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::sift::GeographicTuple const &', 'arg0')])
    ## sift-repository.h (module 'sift'): ns3::sift::GeographicTuple::dataRecordedTime [variable]
    cls.add_instance_attribute('dataRecordedTime', 'ns3::Time', is_const=False)
    ## sift-repository.h (module 'sift'): ns3::sift::GeographicTuple::expireTime [variable]
    cls.add_instance_attribute('expireTime', 'ns3::Time', is_const=False)
    ## sift-repository.h (module 'sift'): ns3::sift::GeographicTuple::isBeingUpdated [variable]
    cls.add_instance_attribute('isBeingUpdated', 'bool', is_const=False)
    ## sift-repository.h (module 'sift'): ns3::sift::GeographicTuple::isChanged [variable]
    cls.add_instance_attribute('isChanged', 'bool', is_const=False)
    ## sift-repository.h (module 'sift'): ns3::sift::GeographicTuple::nodeAddr [variable]
    cls.add_instance_attribute('nodeAddr', 'ns3::Ipv4Address', is_const=False)
    ## sift-repository.h (module 'sift'): ns3::sift::GeographicTuple::nodeReceivedFrom [variable]
    cls.add_instance_attribute('nodeReceivedFrom', 'ns3::Ipv4Address', is_const=False)
    ## sift-repository.h (module 'sift'): ns3::sift::GeographicTuple::recordedTime [variable]
    cls.add_instance_attribute('recordedTime', 'ns3::Time', is_const=False)
    ## sift-repository.h (module 'sift'): ns3::sift::GeographicTuple::startTime [variable]
    cls.add_instance_attribute('startTime', 'ns3::Time', is_const=False)
    ## sift-repository.h (module 'sift'): ns3::sift::GeographicTuple::xcoord [variable]
    cls.add_instance_attribute('xcoord', 'uint32_t', is_const=False)
    ## sift-repository.h (module 'sift'): ns3::sift::GeographicTuple::xvelocity [variable]
    cls.add_instance_attribute('xvelocity', 'int16_t', is_const=False)
    ## sift-repository.h (module 'sift'): ns3::sift::GeographicTuple::ycoord [variable]
    cls.add_instance_attribute('ycoord', 'uint32_t', is_const=False)
    ## sift-repository.h (module 'sift'): ns3::sift::GeographicTuple::yvelocity [variable]
    cls.add_instance_attribute('yvelocity', 'int16_t', is_const=False)
    ## sift-repository.h (module 'sift'): ns3::sift::GeographicTuple::zcoord [variable]
    cls.add_instance_attribute('zcoord', 'uint32_t', is_const=False)
    ## sift-repository.h (module 'sift'): ns3::sift::GeographicTuple::zvelocity [variable]
    cls.add_instance_attribute('zvelocity', 'int16_t', is_const=False)
    return

def register_Ns3SiftSiftGeo_methods(root_module, cls):
    ## sift-geo.h (module 'sift'): ns3::sift::SiftGeo::SiftGeo(ns3::sift::SiftGeo const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::sift::SiftGeo const &', 'arg0')])
    ## sift-geo.h (module 'sift'): ns3::sift::SiftGeo::SiftGeo() [constructor]
    cls.add_constructor([])
    ## sift-geo.h (module 'sift'): void ns3::sift::SiftGeo::CopyToTempGeographicTuple() [member function]
    cls.add_method('CopyToTempGeographicTuple', 
                   'void', 
                   [])
    ## sift-geo.h (module 'sift'): void ns3::sift::SiftGeo::EraseGeographicTuple(ns3::sift::GeographicTuple const & tuple) [member function]
    cls.add_method('EraseGeographicTuple', 
                   'void', 
                   [param('ns3::sift::GeographicTuple const &', 'tuple')])
    ## sift-geo.h (module 'sift'): ns3::sift::GeographicTuple * ns3::sift::SiftGeo::FindGeographicTuple(ns3::Ipv4Address const & mainAddr) [member function]
    cls.add_method('FindGeographicTuple', 
                   'ns3::sift::GeographicTuple *', 
                   [param('ns3::Ipv4Address const &', 'mainAddr')])
    ## sift-geo.h (module 'sift'): ns3::sift::GeographicSet & ns3::sift::SiftGeo::GetGeographicInfo() [member function]
    cls.add_method('GetGeographicInfo', 
                   'ns3::sift::GeographicSet &', 
                   [])
    ## sift-geo.h (module 'sift'): bool ns3::sift::SiftGeo::GetIsBeingUpdated(ns3::Ipv4Address const nodeAddress) [member function]
    cls.add_method('GetIsBeingUpdated', 
                   'bool', 
                   [param('ns3::Ipv4Address const', 'nodeAddress')])
    ## sift-geo.h (module 'sift'): ns3::sift::GeographicSet & ns3::sift::SiftGeo::GetTempGeographicInfo() [member function]
    cls.add_method('GetTempGeographicInfo', 
                   'ns3::sift::GeographicSet &', 
                   [])
    ## sift-geo.h (module 'sift'): void ns3::sift::SiftGeo::InsertGeographicTuple(ns3::sift::GeographicTuple const & tuple, bool & needTriggerUpdate) [member function]
    cls.add_method('InsertGeographicTuple', 
                   'void', 
                   [param('ns3::sift::GeographicTuple const &', 'tuple'), param('bool &', 'needTriggerUpdate')])
    ## sift-geo.h (module 'sift'): bool ns3::sift::SiftGeo::RemoveNodeFromTempSet(ns3::Ipv4Address node1Address) [member function]
    cls.add_method('RemoveNodeFromTempSet', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'node1Address')])
    ## sift-geo.h (module 'sift'): void ns3::sift::SiftGeo::SetIsBeingUpdated(ns3::Ipv4Address const nodeAddress, bool isBeingUpdated) [member function]
    cls.add_method('SetIsBeingUpdated', 
                   'void', 
                   [param('ns3::Ipv4Address const', 'nodeAddress'), param('bool', 'isBeingUpdated')])
    ## sift-geo.h (module 'sift'): void ns3::sift::SiftGeo::UpdateAllTupleIsChanged(bool isChanged) [member function]
    cls.add_method('UpdateAllTupleIsChanged', 
                   'void', 
                   [param('bool', 'isChanged')])
    ## sift-geo.h (module 'sift'): void ns3::sift::SiftGeo::UpdateLinkIsChanged(ns3::Ipv4Address const nodeAddress, ns3::Ipv4Address const neighborAddress, bool isChanged) [member function]
    cls.add_method('UpdateLinkIsChanged', 
                   'void', 
                   [param('ns3::Ipv4Address const', 'nodeAddress'), param('ns3::Ipv4Address const', 'neighborAddress'), param('bool', 'isChanged')])
    ## sift-geo.h (module 'sift'): void ns3::sift::SiftGeo::UpdateLinkIsChanged(bool isChanged) [member function]
    cls.add_method('UpdateLinkIsChanged', 
                   'void', 
                   [param('bool', 'isChanged')])
    ## sift-geo.h (module 'sift'): void ns3::sift::SiftGeo::UpdateTupleIsChanged(ns3::Ipv4Address const nodeAddress, bool isChanged) [member function]
    cls.add_method('UpdateTupleIsChanged', 
                   'void', 
                   [param('ns3::Ipv4Address const', 'nodeAddress'), param('bool', 'isChanged')])
    return

def register_Ns3SiftSiftHeader_methods(root_module, cls):
    ## sift-header.h (module 'sift'): ns3::sift::SiftHeader::SiftHeader(ns3::sift::SiftHeader const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::sift::SiftHeader const &', 'arg0')])
    ## sift-header.h (module 'sift'): ns3::sift::SiftHeader::SiftHeader() [constructor]
    cls.add_constructor([])
    ## sift-header.h (module 'sift'): uint32_t ns3::sift::SiftHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## sift-header.h (module 'sift'): ns3::Ipv4Address ns3::sift::SiftHeader::GetDestAddress() const [member function]
    cls.add_method('GetDestAddress', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## sift-header.h (module 'sift'): int32_t ns3::sift::SiftHeader::GetDestXLoc() const [member function]
    cls.add_method('GetDestXLoc', 
                   'int32_t', 
                   [], 
                   is_const=True)
    ## sift-header.h (module 'sift'): int32_t ns3::sift::SiftHeader::GetDestYLoc() const [member function]
    cls.add_method('GetDestYLoc', 
                   'int32_t', 
                   [], 
                   is_const=True)
    ## sift-header.h (module 'sift'): uint16_t ns3::sift::SiftHeader::GetHeaderSeqNo() const [member function]
    cls.add_method('GetHeaderSeqNo', 
                   'uint16_t', 
                   [], 
                   is_const=True)
    ## sift-header.h (module 'sift'): uint8_t ns3::sift::SiftHeader::GetHeaderTTL() const [member function]
    cls.add_method('GetHeaderTTL', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## sift-header.h (module 'sift'): ns3::TypeId ns3::sift::SiftHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## sift-header.h (module 'sift'): int32_t ns3::sift::SiftHeader::GetLastSourceXLoc() const [member function]
    cls.add_method('GetLastSourceXLoc', 
                   'int32_t', 
                   [], 
                   is_const=True)
    ## sift-header.h (module 'sift'): int32_t ns3::sift::SiftHeader::GetLastSourceYLoc() const [member function]
    cls.add_method('GetLastSourceYLoc', 
                   'int32_t', 
                   [], 
                   is_const=True)
    ## sift-header.h (module 'sift'): uint8_t ns3::sift::SiftHeader::GetMessageType() const [member function]
    cls.add_method('GetMessageType', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## sift-header.h (module 'sift'): uint8_t ns3::sift::SiftHeader::GetNextHeader() const [member function]
    cls.add_method('GetNextHeader', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## sift-header.h (module 'sift'): ns3::Ipv4Address ns3::sift::SiftHeader::GetNodeAddress(uint8_t index) const [member function]
    cls.add_method('GetNodeAddress', 
                   'ns3::Ipv4Address', 
                   [param('uint8_t', 'index')], 
                   is_const=True)
    ## sift-header.h (module 'sift'): uint8_t ns3::sift::SiftHeader::GetNodeListSize() const [member function]
    cls.add_method('GetNodeListSize', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## sift-header.h (module 'sift'): std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > ns3::sift::SiftHeader::GetNodesAddresses() const [member function]
    cls.add_method('GetNodesAddresses', 
                   'std::vector< ns3::Ipv4Address >', 
                   [], 
                   is_const=True)
    ## sift-header.h (module 'sift'): uint8_t ns3::sift::SiftHeader::GetOptionLength() const [member function]
    cls.add_method('GetOptionLength', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## sift-header.h (module 'sift'): uint8_t ns3::sift::SiftHeader::GetSegmentsLeft() const [member function]
    cls.add_method('GetSegmentsLeft', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## sift-header.h (module 'sift'): uint32_t ns3::sift::SiftHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## sift-header.h (module 'sift'): ns3::Ipv4Address ns3::sift::SiftHeader::GetSourceAddress() const [member function]
    cls.add_method('GetSourceAddress', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## sift-header.h (module 'sift'): int32_t ns3::sift::SiftHeader::GetSourceXLoc() const [member function]
    cls.add_method('GetSourceXLoc', 
                   'int32_t', 
                   [], 
                   is_const=True)
    ## sift-header.h (module 'sift'): int32_t ns3::sift::SiftHeader::GetSourceYLoc() const [member function]
    cls.add_method('GetSourceYLoc', 
                   'int32_t', 
                   [], 
                   is_const=True)
    ## sift-header.h (module 'sift'): static ns3::TypeId ns3::sift::SiftHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## sift-header.h (module 'sift'): void ns3::sift::SiftHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## sift-header.h (module 'sift'): void ns3::sift::SiftHeader::Print() [member function]
    cls.add_method('Print', 
                   'void', 
                   [], 
                   is_virtual=True)
    ## sift-header.h (module 'sift'): void ns3::sift::SiftHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## sift-header.h (module 'sift'): void ns3::sift::SiftHeader::SetDestAddress(ns3::Ipv4Address address) [member function]
    cls.add_method('SetDestAddress', 
                   'void', 
                   [param('ns3::Ipv4Address', 'address')])
    ## sift-header.h (module 'sift'): void ns3::sift::SiftHeader::SetDestXLoc(int32_t x) [member function]
    cls.add_method('SetDestXLoc', 
                   'void', 
                   [param('int32_t', 'x')])
    ## sift-header.h (module 'sift'): void ns3::sift::SiftHeader::SetDestYLoc(int32_t y) [member function]
    cls.add_method('SetDestYLoc', 
                   'void', 
                   [param('int32_t', 'y')])
    ## sift-header.h (module 'sift'): void ns3::sift::SiftHeader::SetHeaderSeqNo(uint16_t seqNo) [member function]
    cls.add_method('SetHeaderSeqNo', 
                   'void', 
                   [param('uint16_t', 'seqNo')])
    ## sift-header.h (module 'sift'): void ns3::sift::SiftHeader::SetHeaderTTL(uint8_t ttl) [member function]
    cls.add_method('SetHeaderTTL', 
                   'void', 
                   [param('uint8_t', 'ttl')])
    ## sift-header.h (module 'sift'): void ns3::sift::SiftHeader::SetLastSourceXLoc(int32_t x) [member function]
    cls.add_method('SetLastSourceXLoc', 
                   'void', 
                   [param('int32_t', 'x')])
    ## sift-header.h (module 'sift'): void ns3::sift::SiftHeader::SetLastSourceYLoc(int32_t y) [member function]
    cls.add_method('SetLastSourceYLoc', 
                   'void', 
                   [param('int32_t', 'y')])
    ## sift-header.h (module 'sift'): void ns3::sift::SiftHeader::SetMessageType(uint8_t messageType) [member function]
    cls.add_method('SetMessageType', 
                   'void', 
                   [param('uint8_t', 'messageType')])
    ## sift-header.h (module 'sift'): void ns3::sift::SiftHeader::SetNextHeader(uint8_t protocol) [member function]
    cls.add_method('SetNextHeader', 
                   'void', 
                   [param('uint8_t', 'protocol')])
    ## sift-header.h (module 'sift'): void ns3::sift::SiftHeader::SetNodeAddress(uint8_t index, ns3::Ipv4Address addr) [member function]
    cls.add_method('SetNodeAddress', 
                   'void', 
                   [param('uint8_t', 'index'), param('ns3::Ipv4Address', 'addr')])
    ## sift-header.h (module 'sift'): void ns3::sift::SiftHeader::SetNodesAddress(std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > ipv4Address) [member function]
    cls.add_method('SetNodesAddress', 
                   'void', 
                   [param('std::vector< ns3::Ipv4Address >', 'ipv4Address')])
    ## sift-header.h (module 'sift'): void ns3::sift::SiftHeader::SetNumberAddress(uint8_t n) [member function]
    cls.add_method('SetNumberAddress', 
                   'void', 
                   [param('uint8_t', 'n')])
    ## sift-header.h (module 'sift'): void ns3::sift::SiftHeader::SetOptionLength(uint8_t optionLength) [member function]
    cls.add_method('SetOptionLength', 
                   'void', 
                   [param('uint8_t', 'optionLength')])
    ## sift-header.h (module 'sift'): void ns3::sift::SiftHeader::SetSegmentsLeft(uint8_t segmentsLeft) [member function]
    cls.add_method('SetSegmentsLeft', 
                   'void', 
                   [param('uint8_t', 'segmentsLeft')])
    ## sift-header.h (module 'sift'): void ns3::sift::SiftHeader::SetSourceAddress(ns3::Ipv4Address address) [member function]
    cls.add_method('SetSourceAddress', 
                   'void', 
                   [param('ns3::Ipv4Address', 'address')])
    ## sift-header.h (module 'sift'): void ns3::sift::SiftHeader::SetSourceXLoc(int32_t x) [member function]
    cls.add_method('SetSourceXLoc', 
                   'void', 
                   [param('int32_t', 'x')])
    ## sift-header.h (module 'sift'): void ns3::sift::SiftHeader::SetSourceYLoc(int32_t y) [member function]
    cls.add_method('SetSourceYLoc', 
                   'void', 
                   [param('int32_t', 'y')])
    ## sift-header.h (module 'sift'): void ns3::sift::SiftHeader::UpdateHeaderTTL() [member function]
    cls.add_method('UpdateHeaderTTL', 
                   'void', 
                   [])
    return

def register_Ns3SiftSiftRouting_methods(root_module, cls):
    ## sift-routing.h (module 'sift'): ns3::sift::SiftRouting::SiftRouting(ns3::sift::SiftRouting const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::sift::SiftRouting const &', 'arg0')])
    ## sift-routing.h (module 'sift'): ns3::sift::SiftRouting::SiftRouting() [constructor]
    cls.add_constructor([])
    ## sift-routing.h (module 'sift'): void ns3::sift::SiftRouting::AddGeographicTuple(ns3::sift::GeographicTuple const & tuple) [member function]
    cls.add_method('AddGeographicTuple', 
                   'void', 
                   [param('ns3::sift::GeographicTuple const &', 'tuple')])
    ## sift-routing.h (module 'sift'): void ns3::sift::SiftRouting::AddNode(ns3::Ptr<ns3::Node> node) [member function]
    cls.add_method('AddNode', 
                   'void', 
                   [param('ns3::Ptr< ns3::Node >', 'node')])
    ## sift-routing.h (module 'sift'): int64_t ns3::sift::SiftRouting::AssignStreams(int64_t stream) [member function]
    cls.add_method('AssignStreams', 
                   'int64_t', 
                   [param('int64_t', 'stream')])
    ## sift-routing.h (module 'sift'): void ns3::sift::SiftRouting::CancelTimer(ns3::Ptr<ns3::Packet> p) [member function]
    cls.add_method('CancelTimer', 
                   'void', 
                   [param('ns3::Ptr< ns3::Packet >', 'p')])
    ## sift-routing.h (module 'sift'): void ns3::sift::SiftRouting::ForwardPacket(ns3::Ptr<ns3::Packet> packet, ns3::Ipv4Address source, uint8_t protocol) [member function]
    cls.add_method('ForwardPacket', 
                   'void', 
                   [param('ns3::Ptr< ns3::Packet >', 'packet'), param('ns3::Ipv4Address', 'source'), param('uint8_t', 'protocol')])
    ## sift-routing.h (module 'sift'): ns3::Callback<void, ns3::Ptr<ns3::Packet>, ns3::Ipv4Address, ns3::Ipv4Address, unsigned char, ns3::Ptr<ns3::Ipv4Route>, ns3::empty, ns3::empty, ns3::empty, ns3::empty> ns3::sift::SiftRouting::GetDownTarget() const [member function]
    cls.add_method('GetDownTarget', 
                   'ns3::Callback< void, ns3::Ptr< ns3::Packet >, ns3::Ipv4Address, ns3::Ipv4Address, unsigned char, ns3::Ptr< ns3::Ipv4Route >, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 
                   [], 
                   is_const=True, is_virtual=True)
    ## sift-routing.h (module 'sift'): ns3::Callback<void, ns3::Ptr<ns3::Packet>, ns3::Ipv6Address, ns3::Ipv6Address, unsigned char, ns3::Ptr<ns3::Ipv6Route>, ns3::empty, ns3::empty, ns3::empty, ns3::empty> ns3::sift::SiftRouting::GetDownTarget6() const [member function]
    cls.add_method('GetDownTarget6', 
                   'ns3::Callback< void, ns3::Ptr< ns3::Packet >, ns3::Ipv6Address, ns3::Ipv6Address, unsigned char, ns3::Ptr< ns3::Ipv6Route >, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 
                   [], 
                   is_const=True, is_virtual=True)
    ## sift-routing.h (module 'sift'): ns3::Ptr<ns3::Node> ns3::sift::SiftRouting::GetNode() const [member function]
    cls.add_method('GetNode', 
                   'ns3::Ptr< ns3::Node >', 
                   [], 
                   is_const=True)
    ## sift-routing.h (module 'sift'): ns3::Ptr<ns3::Node> ns3::sift::SiftRouting::GetNodeWithAddress(ns3::Ipv4Address ipv4Address) [member function]
    cls.add_method('GetNodeWithAddress', 
                   'ns3::Ptr< ns3::Node >', 
                   [param('ns3::Ipv4Address', 'ipv4Address')])
    ## sift-routing.h (module 'sift'): uint32_t ns3::sift::SiftRouting::GetNodesSize() [member function]
    cls.add_method('GetNodesSize', 
                   'uint32_t', 
                   [])
    ## sift-routing.h (module 'sift'): int ns3::sift::SiftRouting::GetProtocolNumber() const [member function]
    cls.add_method('GetProtocolNumber', 
                   'int', 
                   [], 
                   is_const=True, is_virtual=True)
    ## sift-routing.h (module 'sift'): std::map<ns3::Ptr<ns3::Packet>, ns3::Time, std::less<ns3::Ptr<ns3::Packet> >, std::allocator<std::pair<ns3::Ptr<ns3::Packet> const, ns3::Time> > > ns3::sift::SiftRouting::GetReceiveBuffer() [member function]
    cls.add_method('GetReceiveBuffer', 
                   'std::map< ns3::Ptr< ns3::Packet >, ns3::Time >', 
                   [])
    ## sift-routing.h (module 'sift'): uint16_t ns3::sift::SiftRouting::GetSeqNo() [member function]
    cls.add_method('GetSeqNo', 
                   'uint16_t', 
                   [])
    ## sift-routing.h (module 'sift'): static ns3::TypeId ns3::sift::SiftRouting::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## sift-routing.h (module 'sift'): void ns3::sift::SiftRouting::PrintReceiveBuffer() [member function]
    cls.add_method('PrintReceiveBuffer', 
                   'void', 
                   [])
    ## sift-routing.h (module 'sift'): void ns3::sift::SiftRouting::PrintSiftHeader(ns3::sift::SiftHeader arg0, ns3::sift::GeographicTuple arg1) [member function]
    cls.add_method('PrintSiftHeader', 
                   'void', 
                   [param('ns3::sift::SiftHeader', 'arg0'), param('ns3::sift::GeographicTuple', 'arg1')])
    ## sift-routing.h (module 'sift'): void ns3::sift::SiftRouting::PrintVector(std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > & vec) [member function]
    cls.add_method('PrintVector', 
                   'void', 
                   [param('std::vector< ns3::Ipv4Address > &', 'vec')])
    ## sift-routing.h (module 'sift'): ns3::IpL4Protocol::RxStatus ns3::sift::SiftRouting::Receive(ns3::Ptr<ns3::Packet> p, ns3::Ipv4Header const & header, ns3::Ptr<ns3::Ipv4Interface> incomingInterface) [member function]
    cls.add_method('Receive', 
                   'ns3::IpL4Protocol::RxStatus', 
                   [param('ns3::Ptr< ns3::Packet >', 'p'), param('ns3::Ipv4Header const &', 'header'), param('ns3::Ptr< ns3::Ipv4Interface >', 'incomingInterface')], 
                   is_virtual=True)
    ## sift-routing.h (module 'sift'): ns3::IpL4Protocol::RxStatus ns3::sift::SiftRouting::Receive(ns3::Ptr<ns3::Packet> p, ns3::Ipv6Header const & header, ns3::Ptr<ns3::Ipv6Interface> incomingInterface) [member function]
    cls.add_method('Receive', 
                   'ns3::IpL4Protocol::RxStatus', 
                   [param('ns3::Ptr< ns3::Packet >', 'p'), param('ns3::Ipv6Header const &', 'header'), param('ns3::Ptr< ns3::Ipv6Interface >', 'incomingInterface')], 
                   is_virtual=True)
    ## sift-routing.h (module 'sift'): void ns3::sift::SiftRouting::ScheduleTimer(ns3::Ptr<ns3::Packet> packet, ns3::Time timer, ns3::Ipv4Address source, uint8_t protocol) [member function]
    cls.add_method('ScheduleTimer', 
                   'void', 
                   [param('ns3::Ptr< ns3::Packet >', 'packet'), param('ns3::Time', 'timer'), param('ns3::Ipv4Address', 'source'), param('uint8_t', 'protocol')])
    ## sift-routing.h (module 'sift'): void ns3::sift::SiftRouting::Send(ns3::Ptr<ns3::Packet> packet, ns3::Ipv4Address source, ns3::Ipv4Address destination, uint8_t protocol, ns3::Ptr<ns3::Ipv4Route> route) [member function]
    cls.add_method('Send', 
                   'void', 
                   [param('ns3::Ptr< ns3::Packet >', 'packet'), param('ns3::Ipv4Address', 'source'), param('ns3::Ipv4Address', 'destination'), param('uint8_t', 'protocol'), param('ns3::Ptr< ns3::Ipv4Route >', 'route')])
    ## sift-routing.h (module 'sift'): void ns3::sift::SiftRouting::SendPacket(ns3::Ptr<ns3::Packet> packet, ns3::Ipv4Address source, ns3::Ipv4Address nextHop, uint8_t protocol) [member function]
    cls.add_method('SendPacket', 
                   'void', 
                   [param('ns3::Ptr< ns3::Packet >', 'packet'), param('ns3::Ipv4Address', 'source'), param('ns3::Ipv4Address', 'nextHop'), param('uint8_t', 'protocol')])
    ## sift-routing.h (module 'sift'): void ns3::sift::SiftRouting::SetDownTarget(ns3::Callback<void, ns3::Ptr<ns3::Packet>, ns3::Ipv4Address, ns3::Ipv4Address, unsigned char, ns3::Ptr<ns3::Ipv4Route>, ns3::empty, ns3::empty, ns3::empty, ns3::empty> callback) [member function]
    cls.add_method('SetDownTarget', 
                   'void', 
                   ...
                   is_virtual=True)
    ## sift-routing.h (module 'sift'): void ns3::sift::SiftRouting::SetDownTarget6(ns3::Callback<void, ns3::Ptr<ns3::Packet>, ns3::Ipv6Address, ns3::Ipv6Address, unsigned char, ns3::Ptr<ns3::Ipv6Route>, ns3::empty, ns3::empty, ns3::empty, ns3::empty> callback) [member function]
    cls.add_method('SetDownTarget6', 
                   'void', 
                   ...
                   is_virtual=True)
    ## sift-routing.h (module 'sift'): void ns3::sift::SiftRouting::SetNode(ns3::Ptr<ns3::Node> node) [member function]
    cls.add_method('SetNode', 
                   'void', 
                   [param('ns3::Ptr< ns3::Node >', 'node')])
    ## sift-routing.h (module 'sift'): ns3::Ptr<ns3::Ipv4Route> ns3::sift::SiftRouting::SetRoute(ns3::Ipv4Address nextHop, ns3::Ipv4Address srcAddress) [member function]
    cls.add_method('SetRoute', 
                   'ns3::Ptr< ns3::Ipv4Route >', 
                   [param('ns3::Ipv4Address', 'nextHop'), param('ns3::Ipv4Address', 'srcAddress')])
    ## sift-routing.h (module 'sift'): void ns3::sift::SiftRouting::SetSeqNo(uint16_t sno) [member function]
    cls.add_method('SetSeqNo', 
                   'void', 
                   [param('uint16_t', 'sno')])
    ## sift-routing.h (module 'sift'): ns3::sift::SiftRouting::PROT_NUMBER [variable]
    cls.add_static_attribute('PROT_NUMBER', 'uint8_t const', is_const=True)
    ## sift-routing.h (module 'sift'): ns3::sift::SiftRouting::m_state [variable]
    cls.add_instance_attribute('m_state', 'ns3::sift::SiftGeo', is_const=False)
    ## sift-routing.h (module 'sift'): void ns3::sift::SiftRouting::DoDispose() [member function]
    cls.add_method('DoDispose', 
                   'void', 
                   [], 
                   visibility='protected', is_virtual=True)
    ## sift-routing.h (module 'sift'): void ns3::sift::SiftRouting::NotifyNewAggregate() [member function]
    cls.add_method('NotifyNewAggregate', 
                   'void', 
                   [], 
                   visibility='protected', is_virtual=True)
...
def register_Ns3SiftTimeFragments_methods(root_module, cls):
    ## sift-geo.h (module 'sift'): ns3::sift::TimeFragments::TimeFragments() [constructor]
    cls.add_constructor([])
    ## sift-geo.h (module 'sift'): ns3::sift::TimeFragments::TimeFragments(ns3::sift::TimeFragments const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::sift::TimeFragments const &', 'arg0')])
    ## sift-geo.h (module 'sift'): ns3::sift::TimeFragments::fragmentNumber [variable]
    cls.add_instance_attribute('fragmentNumber', 'uint16_t', is_const=False)
    ## sift-geo.h (module 'sift'): ns3::sift::TimeFragments::recordedTime [variable]
    cls.add_instance_attribute('recordedTime', 'ns3::Time', is_const=False)
    return
...
def register_functions(root_module):
    ...
    register_functions_ns3_sift(module.get_submodule('sift'), root_module)
    return
...
def register_functions_ns3_sift(module, root_module):
    return
